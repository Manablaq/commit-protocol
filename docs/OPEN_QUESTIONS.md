...
`0.7.0-reviewable-manifest` candidate and the prior revisions' verified
...
| ENV-03 | Exact Studio Dev, consensus and GenVM runtime? | Matching RC CLI `0.40.0-rc.3`, Studio Dev chain 61997, v0.6 `5jyc...` runner, and source-matched v0.5/v0.6 deployments verified 2026-09-11; `0.7.0-reviewable-manifest` local candidate is not yet deployed | Repeat deployment/source verification for `0.7.0` |
...
The next release work is source-matched deployment of `0.7.0-reviewable-manifest`,
live manifest readback, then authenticated external-transfer reconciliation/retry, live
