...
| ENV-03 | Exact Studio, consensus and GenVM runtime? | GenVM manager v0.6.0-rc4 release archive verified; Bradbury rejected the current `5jyc...` runner; corrected `1jb45...` canary is live in `COMMITTING` with no final receipt yet | Successful Bradbury deployment with `1jb45...` and final receipt |
